 ...
 */
function GET_EDGE_EXE_VERSION(version) {
 ...
 */
async function installEdgeDriver(version, toPath) {
 ...
 * @param toPath {string} - The path to download the Edge driver to.
 */
async function downloadEdgeDriver(version, toPath) {
 ...
 */
function unzipEdgeDriver(fromPath, toPath) {
...
//# sourceMappingURL=edge-driver.js.map